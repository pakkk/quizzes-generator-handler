...
package com.pacobenitezchico.quizzes.api.exception ;
...
public final class ApiException extends Exception
{
	 ...
	 */
	public ApiException(final String error, final Exception exception)
	{
		// Default error value
		this(DEFAULT_ERR_CODE) ;
	 ...
	 * @param exception with the exception
	 */
    public ApiException(final String error, final String message, final String exception)
    {
    	// Default error value
        this(DEFAULT_ERR_CODE) ;
	 ...
	 * @param exception with the exception
	 */
	public ApiException(final int status, final String error, final Exception exception)
	{
		// Default error value
		this(status) ;
	 ...
	 * @param exception with the exception
	 */
    public ApiException(final int status, final String error, final String message, final String exception)
    {
    	// Default error value
        this(status) ;
